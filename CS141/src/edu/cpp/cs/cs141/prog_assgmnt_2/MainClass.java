...
/**
 * @author alexandra Main class: the class where main resides, from which the
 *         program is launched
 */
public class MainClass {

	/**
	 * Create a main method which launches the program
	 * by calling the UserInterface class.
	 */
